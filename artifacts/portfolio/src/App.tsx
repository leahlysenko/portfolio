...
const PROJECTS = [
  ...
  },
  {
    ...
    result: "4 продуктовые программы-онбординга для разных направлений технических специалистов, 4 аттестационных экзамена, которые я\u00a0веду под ключ уже 2 года — от\u00a0взаимодействия с\u00a0заказчиком и\u00a0предметными экспертами до\u00a0проектирования программ, разработки материалов и\u00a0квалификационных листов оценки. Также в\u00a0мою зону ответственности на\u00a0этом проекте входит проведение самих аттестаций и\u00a0взаимодействие с\u00a0кандидатами от\u00a0компаний-партнёров.",
    ...
    decisions: [
      ...
      "Одна из\u00a0постоянных задач — организовывать доступность предметных экспертов продукта: без их вовлечённости не\u00a0создать базу знаний и\u00a0не\u00a0провести аттестацию. Поэтому приходится балансировать между скоростью обновлений в\u00a0продукте, выпуском материалов и\u00a0высокой занятостью экспертов.",
    ],
  },
];
